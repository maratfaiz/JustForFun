...
ARMS = {
    ...
    "clap": (152, 730, 74, 152, 68),     # ладони перед собой, с просветом
    "hug": (186, 700, 74, 150, 54),      # обнимает — чуть ниже, чем hold
    "float": (286, 646, 76, 152, -30),   # отведены от корпуса, с просветом
}
...
POSES = {
    ...
    # медитация: парит с чуть приподнятыми руками
    "float": ("float", "float", "stand"),
    # лотос: руки на своих местах (приподняты), скрещённые ноги рисует сцена
    "lotus": ("float", "float", "none"),
}
